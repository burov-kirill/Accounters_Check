...
#     sixth_slide(root,tables_dict['best_company'], PLOT_DICT['best_company'], tables_dict['worst_company'], PLOT_DICT['worst_company'])
...
header_dict = { 'Chart 1': 'Соблюдение Регламентируемых сроков закрытия',
                ...
                'Chart 5': 'Общие данные по закрытию Июля, включая промежуточные участки',
                'Chart 7': 'Рейтинги категории «труднозакрываемых» организаций группы Самолёт',
                'Chart 8': 'Анализ закрытия участков РСБУ'
}
